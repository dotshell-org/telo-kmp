...
-keep class eu.dotshell.telo.generic.data.models.** { *; }
-keep class eu.dotshell.telo.specific.data.model.** { *; }
...
-keep class eu.dotshell.telo.generic.data.config.AppConfig { *; }
-keep class eu.dotshell.telo.generic.data.config.**Data { *; }
...
-keepclassmembers @kotlinx.serialization.Serializable class eu.dotshell.telo.** {
    *** Companion;
    *** INSTANCE;
    kotlinx.serialization.KSerializer serializer(...);
}
...
-keep class eu.dotshell.telo.generic.data.telemetry.** { *; }
-keep class eu.dotshell.telo.generic.data.local_history.** { *; }
