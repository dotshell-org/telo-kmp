...
import eu.dotshell.telo.MainActivity
import eu.dotshell.telo.R
...
class NavigationModeForegroundService : Service() {
    ...
    companion object {
        const val ACTION_START = "eu.dotshell.telo.action.navigation.START"
        const val ACTION_STOP = "eu.dotshell.telo.action.navigation.STOP"
