package eu.dotshell.telo.generic.worker
...
class TrafficAlertsWorker(
    ...
    private val trafficAlertsRepository = TrafficAlertsRepository(
        ...
        eu.dotshell.telo.platform.Settings(applicationContext, "traffic_alerts_cache"),
        eu.dotshell.telo.generic.data.offline.OfflineRepository(applicationContext)
    )
