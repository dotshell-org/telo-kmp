package eu.dotshell.telo.generic.data.repository.offline

import eu.dotshell.telo.generic.data.local_history.FavoriteAuditEntry
import eu.dotshell.telo.generic.data.models.stops.Favorite
import eu.dotshell.telo.generic.data.repository.api.FavoritesRepository as ApiFavoritesRepository
...
class FavoritesRepository(context: PlatformContext) : ApiFavoritesRepository {
    ...
    private val settings = Settings(context, "telo_prefs")
