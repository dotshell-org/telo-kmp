package eu.dotshell.telo.generic.data.repository.offline.theme
 ...
 * mirroring [eu.dotshell.telo.generic.data.repository.offline.mapstyle.MapStyleRepository].
 */
class ThemePreferenceRepository(context: PlatformContext) {
    private val settings = Settings(context, "telo_theme_prefs")
