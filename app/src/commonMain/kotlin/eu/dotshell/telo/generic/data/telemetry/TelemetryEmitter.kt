package eu.dotshell.telo.generic.data.telemetry

import eu.dotshell.telo.platform.ioDispatcher

import eu.dotshell.telo.generic.data.config.TelemetryConfigData
import eu.dotshell.telo.generic.data.local_history.LocalHistoryStorage
import eu.dotshell.telo.generic.data.local_history.SessionAuditEntry
 ...
 *
 * Lifecycle:
 *  - [initialize] is called once at startup (Android: `TeloApplication.onCreate`).
