...
import eu.dotshell.telo.IosPlatformContext
...
object TelemetryService {
    ...
    fun initialize(context: PlatformContext, config: TelemetryConfigData) {
        ...
        BGTaskScheduler.sharedScheduler.registerForTaskWithIdentifier(
            "eu.dotshell.telo.telemetryUpload",
            usingQueue = null
        ) { task ->
        ...
        BGTaskScheduler.sharedScheduler.registerForTaskWithIdentifier(
            "eu.dotshell.telo.trafficAlerts",
            usingQueue = null
        ) { task ->
            if (task == null) return@registerForTaskWithIdentifier
            val scope = CoroutineScope(SupervisorJob() + Dispatchers.Default)
            ...
            scope.launch {
                try {
                    ...
                    val trafficAlertsRepository = TrafficAlertsRepository(
                        ...
                        eu.dotshell.telo.generic.data.offline.OfflineRepository(IosPlatformContext)
                    )
